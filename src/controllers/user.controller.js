...
const refreshAccessToken = asyncHandler(async(req, res) => {
    const {refreshToken: requestRefreshToken} = req.cookies.refreshToken || req.body.refreshToken
    ...
    try {
        const decoded = jwt.verify(incomingRefreshToken, ProcessingInstruction.env.REFRESH_TOKEN_SECRET
